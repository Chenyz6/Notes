...
![image-20230604171622790](Linux系统编程笔记.assets/image-20230604171622790.png)

ps ajx    查看父进程ID，进程ID，进程组ID，会话ID的方法：ps ajx

![image-20230604171558335](Linux系统编程笔记.assets/image-20230604171558335.png)
...
![image-20230604153928744](Linux系统编程笔记.assets/image-20230604153928744.png)

未决信号集和信号屏蔽字在内存控制块的位置

![image-20230604153749941](Linux系统编程笔记.assets/image-20230604153749941.png)
...
![image-20230604163345501](Linux系统编程笔记.assets/image-20230604163345501.png)



## kill命令 kill函数

![image-20230604165112194](Linux系统编程笔记.assets/image-20230604165112194.png)
